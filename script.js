...
let topSection = document.getElementsByClassName('top-section')
let container = ''
for(let i=0; i< productList.length;i++){
  if(productList[i].id<6){
    let element = '<div class="card"><img class="dress" src="'+productList[i].preview+'" alt=""><div class="blogtext"><h4 id="ptd1">'+productList[i].name+'</h4><p>'+productList[i].brand+'</p><h5> Rs '+productList[i].price+'</h5></div></div>'
    container += element
  }
}
topSection[0].innerHTML = container

let bottomSection = document.getElementsByClassName('bottom-section')
let container2 = ''
for(let i=0; i< productList.length;i++){
  if(productList[i].id>=6){
    let element = '<div class="card"><img class="dress" src="'+productList[i].preview+'" alt=""><div class="blogtext"><h4 id="ptd1">'+productList[i].name+'</h4><p>'+productList[i].brand+'</p><h5> Rs '+productList[i].price+'</h5></div></div>'
...
bottomSection[0].innerHTML = container2
